...
;;;; Constant values
  ...
  (define messages
    '("A 3D model of a bunny containing 69451 polygons. You do not feel like verifying that claim."
      ...
      "A cheque from Donald Knuth, for $0x08."
      ...
      "A feraliminal lycanthropiser. You have no idea what that means, so move on."
      ...
      "A magniloquent explanans in search of explanada."
      "A monkey banging away on a typewriter... This is William Shakespeare the Second!"
      "A pencil sketch of Barbara Liskov."
      "A picture of a woman wearing a hat with feathers. Compression artefacts distorted her face but she looks familiar."
      ...
      "An armful of cons cells lying around."
      ...
      "The bit bucket. So that's where everything goes!"
      ...
      "This is a set of foot pedals, labelled C, M and H."
      ...
      "This is a tattered calendar of the year 1969, featuring Snoopy in ASCII art."
      ...
      "This is an Xmas wreath, made of IBM punch cards."
      "Why would you want to do that?"
      "You come across a line printer, happily printing away the source of its drivers."
      "You found Sussman's fez. Better return it to him."
      "You found some slack."
      "You found a spray can labelled 'Ubik'. It's best not to touch it."
